...
public class getArticle 
{
	...
	private String SELECT_SQLS[] = {"select * from article where User_Id = ?",
									"select article.* from collection,article where collection.User_Id = ? and collection.Article_Id = article.Article_Id"
									};
