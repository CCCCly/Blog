...
public class DeleteLike extends ActionSupport
{
	...
	public String execute()
	{
		...
		String DELETE_SQL = "delete from artlike where User_Id = ? and Article_ID = ?";
		try
		{
			...
			{
				session.setAttribute("dealforummsg","取消点赞失败!");
				out.print("数据库关闭失败!");
		...
		session.setAttribute("dealforummsg","取消点赞成功!");
		try 
		{
